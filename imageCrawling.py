...
food_items = [
    ...
    "떡국_만두국", "무국", "미역국", "북엇국", "시래기국", "육개장", "콩나물국", "콩자반", "갓김치", "깍두기", "무생채",
    ...
    "동태찌개", "순두부찌개", "계란찜", "김치찜", "해물찜", "갈비탕", "감자탕", "곰탕_설렁탕", "매운탕", "삼계탕",
    ...
    "마파두부", "마라탕", "멘보샤", "부추잡채", "오향장육", "울면", "유린기", "유산슬", "자춘걸", "크램새우",
    ...
    "칠면조", "오렌지 주스", "스무디", "티라미수", "브라우니", "케이크", "딤섬", "우육면", "타코야키", "닭가슴살",
...
for food_item in food_items:
    ...
    # 검색어 입력
    keyElement = driver.find_element(By.XPATH, '//*[@id="APjFqb"]')  # XPATH 수정 필요
    keyElement.clear()
