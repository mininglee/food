...
source_directory = "C:/Users/koung/kicpython/hansik/kfood_new/learning/"
invalid_image_list = process_and_save_images(source_directory)
df = pd.DataFrame(Z)
df
df.to_excel('C:/Users/koung/kicpython/hansik/errorimage.xlsx',index=True)
Z
X
len(Z)
len(X)
...
# 폴더내 확장자 추출
directory = "C:/Users/koung/kicpython/hansik/kfood_new/learning/"
H = []
...
def modify_and_save_image(cate,cnt):
    ...
    # 파일 경로 설정
    input_directory = "C:/Users/koung/kicpython/hansik/kfood_new/learning/{category}/"
    # 추출해낸 확장자 선택지에 넣기
    ...
    # 수정된 이미지를 새 파일로 저장
    output_directory = "C:/Users/koung/kicpython/hansik/kfood_new/learning_rgb5/{category}/"
...
for category in categories:
    ...
    data_dir = pathlib.Path("C:/Users/koung/kicpython/hansik/kfood_new/learning/{category}/")
    os.makedirs("C:/Users/koung/kicpython/hansik/kfood_new/learning_rgb5/{category}/", exist_ok=True)
...
def modify_and_save_image_test(cate,cnt):
    exten = ['.jpg','.JPG','.png','.PNG','.gif','.GIF','.jpeg','.JPEG']
    # 파일 경로 설정
    input_directory = "C:/Users/koung/kicpython/hansik/kfood_new/test/"+cate+"/"
    # 추출해낸 확장자 선택지에 넣기
    ...
    img = img.resize((new_width, new_height))
    # 수정된 이미지를 새 파일로 저장
    output_directory = "C:/Users/koung/kicpython/hansik/kfood_new/test_rgb5/"+cate+"/"
    file_name_out = cnt + ".jpg"
    output_file_path = os.path.join(output_directory, file_name_out)
    img.save(output_file_path)
...
for category in categories:
    print("category: ", category)
    input_directory = f"C:/Users/koung/kicpython/hansik/kfood_new/learning/{category}/"
    os.makedirs(f"C:/Users/koung/kicpython/hansik/kfood_new/learning_rgb5/{category}/", exist_ok=True)
